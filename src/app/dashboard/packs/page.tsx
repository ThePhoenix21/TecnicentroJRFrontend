                ...
                <TableBody>
                  {packs.map((pack) => (
                    <TableRow key={pack.id}>
                      ...
                      <TableCell>{formatCurrency(Number(pack.fixedPrice || 0))}</TableCell>
                      <TableCell>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-2">
                          <Button variant="outline" size="sm" onClick={() => void openDetail(pack.id)}>
                            Ver
                          </Button>
                          {canManagePacks && (
                            <>
                              <Button variant="outline" size="sm" onClick={() => void openEditForm(pack.id)}>
                                Editar
                              </Button>
                              <Button variant="outline" size="sm" onClick={() => void handleToggleActive(pack)}>
                                {pack.isActive ? "Desactivar" : "Activar"}
                              </Button>
                              <Button variant="destructive" size="sm" onClick={() => void handleDelete(pack)}>
